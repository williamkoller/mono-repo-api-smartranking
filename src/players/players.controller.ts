...
export class PlayersController {
  ...
  @Get('/:_id')
  async searchByPlayerId(@Param('_id', ValidationParamsPipe) _id: string): Promise<CreatePlayerDTO> {
    return await this.playersService.searchByPlayerId(_id)
  }

  @Delete('/:_id')
  async deletePlayerById(@Param('_id', ValidationParamsPipe) _id: string): Promise<ReturnTypeResponse> {
